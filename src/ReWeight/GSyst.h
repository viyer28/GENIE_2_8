...
namespace genie {
  namespace rew   {
    ...
    typedef enum EGSyst {
      ...
      kKNO_AvgHad_Mult, 
      kKNO_ProbP_Baryon_vn_mult_e2, 
      kKNO_ProbP_Baryon_vp_mult_e2, 
      kKNO_ProbP_Baryon_vbarn_mult_e2, 
      kKNO_ProbP_Baryon_vbarp_mult_e2, 
      kKNO_ProbP_Baryon_vn_mult_gt2, 
	...
	case (kKNO_alpha_vp                  ) : return "KNO_alpha_vp";         break;
	case (kKNO_alpha_vn                  ) : return "kKNO_alpha_vn";        break;
	case (kKNO_alpha_vbarp               ) : return "kKNO_alpha_vbarp";     break;
	case (kKNO_alpha_vbarn               ) : return "kKNO_alpha_vbarn";     break;
	case (kKNO_beta_vp                   ) : return "kKNO_beta_vp";         break;
	case (kKNO_beta_vn                   ) : return "kKNO_beta_vn";         break;
	case (kKNO_beta_vbarp                ) : return "kKNO_beta_vbarp";      break;
	case (kKNO_beta_vbarn                ) : return "kKNO_beta_vbarn";      break;
	case (kKNO_Levyc_vp                  ) : return "kKNO_Levyc_vp";        break;
	case (kKNO_Levyc_vn                  ) : return "kKNO_Levyc_vn";        break;
	case (kKNO_Levyc_vbarp               ) : return "kKNO_Levyc_vbarp";     break;
	case (kKNO_Levyc_vbarn               ) : return "kKNO_Levyc_vbarn";     break;

	case (kKNO_AvgHad_Mult               ) : return "kKNO_AvgHad_Mult";     break; 
	case (kKNO_ProbP_Baryon_vn_mult_e2   ) : return "kKNO_ProbP_Baryon_vn_mult_e2"; break; 
      	case (kKNO_ProbP_Baryon_vp_mult_e2   ) : return "kKNO_ProbP_Baryon_vp_mult_e2"; break; 
	case (kKNO_ProbP_Baryon_vbarn_mult_e2) : return "kKNO_ProbP_Baryon_vbarn_mult_e2"; break; 
	case (kKNO_ProbP_Baryon_vbarp_mult_e2) : return "kKNO_ProbP_Baryon_vbarp_mult_e2"; break; 
